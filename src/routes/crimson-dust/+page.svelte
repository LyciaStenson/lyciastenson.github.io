...
<div class="space-y-5 text-lg">
	...
	<p>
		I have worked closely with the designers to implement the tailored character movement and modular combat action system needed to bring their vision to life.
	</p>
</div>